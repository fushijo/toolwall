...
pub fn show(
    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        settings_grid(ui, "ninb-setup", |ui| {
            ui.label("Jar file");
        ...
        settings_grid(ui, "ninb-readout", |ui| {
            ui.label("Enabled");
        ...
        if o.layout == "compact" {
            ui.heading("Lines");
            settings_grid(ui, "ninb-compact", |ui| {
        ...
        settings_grid(ui, "ninb-colours", |ui| {
            ui.label("Values");
        ...
        settings_grid(ui, "ninb-panel", |ui| {
        ...
        if advanced {
            ...
            settings_grid(ui, "ninb-refresh", |ui| {
...
fn hotkeys(ui: &mut egui::Ui, doc: &mut Document, keys: &mut NinbKeys) {
    ...
    settings_grid(ui, "ninb-hotkeys", |ui| {
